...
\section{The 5 Paradigms}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{5 main paradigms in Machine Learning}
Computers discover knowledge by mimicking the following processes:
  \begin{itemize}
...
\begin{frame}[fragile]\frametitle{Working of Neurons}
  \begin{itemize}
	...
	\item The connections are called synapses. The stronger they are, the higher the weights, the more threshold crossings and transmissions --- the more learning.
...
\begin{frame}[fragile]\frametitle{Connectionists vs Evolutionaries}
  \begin{itemize}
	...
	\item Backpropagation, the staple process by which neural networks are trained, starts from an initial random point for a single hypothesis but then proceeds deterministically in steps to the solution. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Analogizers}
  \begin{itemize}
...
That's the Master Algorithm, a Grand Unified Theory of Machine Learning.
\end{frame}



\section{The Master Algorithm}
