...
\begin{itemize}
  \item \textbf{Wealth, Money \& Status} (1--3)
  \item \textbf{Luck \& Time} (4--7)
  \item \textbf{Markets \& Scale} (8--9)
  \item \textbf{Long-Term Thinking} (10--12)
  \item \textbf{Specific Knowledge} (13--14)
  \item \textbf{Learning \& Foundations} (15--18)
\end{itemize}
\end{column}
\begin{column}{.48\linewidth}
\begin{itemize}
  \item \textbf{Accountability \& Leverage} (19--25)
  \item \textbf{Judgment \& Execution} (26--30)
  \item \textbf{Competition \& Character} (31--40)
  \item \textbf{Mental Models} (41--50)
  \item \textbf{Bonus: Investing in Yourself}
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}
\item People living below their means have freedom that those busy upgrading their lifestyle do not.
...
\item No one can compete with you, due to your originality
\end{itemize}
\end{frame}
...
\item Stand out of the crowd and get paid sustainably if you have Specific Knowledge.
...
\section{Accountability \& Leverage}
...
\item No permissions are needed to use Code/media leverage.
...
\item Top investors often sound like philosophers (wise, evolved, `sorted')
\end{itemize}
\end{frame}
...
\item Get away from the specter of competition; it's stressful and nerve-wracking and will drive you in the wrong direction.
...
\item Don't cut corners or do unethical or downright illegal things. You will be in jail for a small risk/gain. Game over.
...
\item Schelling formulation: How do you get people who cannot communicate with each other to coordinate?
...
it worse in at least one dimension. There is a hard trade-off from this point forward.
...
\item Business-class seats routinely cost five or 10 times more than economy seats. But it costs the airline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
\frametitle{Bonus: Start Where You Are}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
\frametitle{Bonus: Timely vs.\ Timeless Knowledge}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
\frametitle{Bonus: Technology as a Knowledge Domain}
\begin{itemize}
...
\section{Bonus: Investing in Yourself}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
\frametitle{Bonus: Make Your Outputs Visible}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
\frametitle{Bonus: Judgment and Accountability Over Hours}
\begin{itemize}
