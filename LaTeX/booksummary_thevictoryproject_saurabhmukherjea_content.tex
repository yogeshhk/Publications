...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Ch1: A Peek into the Human Mind}
Mind's limitations:
\begin{itemize}
...
\item Simplification types through:
	...
	\item Habits/process/method
		...
		\item Have habits: reading, intense focused work in solitude, rewarding oneself, seeking high quality input and criticism, well-defined daily routine.
		\end{itemize}	
...
\section{Desirable Behaviors (3 C's)}
...
\item Sequential steps to reduce mental clutter:
	...
	\end{itemize}
\item Go for one month digital fast (from Cal Newport)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Ch7 : Teaming Up with the Best}
...
\item Checklist:
	...
	\item  Seek perspectives and viewpoints that are different from yours
...
\item Checklist:
	...
	\item Bring in diverse backgrounds and a variety of experiences
	\end{itemize}
\end{itemize}
