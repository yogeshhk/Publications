  ...
  \begin{columns}
    \begin{column}[T]{0.48\linewidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{Payoffs}: Outcomes that players value (money, safety, reputation)
    ...
    \begin{column}[T]{0.48\linewidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{About} responding to decision-makers who respond to you
        \item Applies wherever outcomes are shaped by interacting choices
